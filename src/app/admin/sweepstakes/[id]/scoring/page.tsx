...
import { ScoringMatrixForm, type SportRules } from "./scoring-form";

export const metadata = { title: "Scoring Matrix — Admin" };
export const revalidate = 0;

// Sports where "half" scoring is meaningful (football & basketball)
