...
import { SportPoolEditor } from "@/app/admin/sweepstakes/[id]/pool/pool-editor";

export const metadata = { title: "Draw Pool — Commissioner" };
export const revalidate = 0;

export default async function CommissionerPoolPage({
  params,
}: {
